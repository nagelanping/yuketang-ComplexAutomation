...
- PPT/课件自动翻页与播放。
- 作业使用浏览器内截图能力截取题面，再通过 OpenAI-compatible API 端口调用多模态模型作答。
- 支持选择题、多选题、判断题、填空题。
...
- `ref/yuketang-jiaoben/` [Niuwh/yuketang-jiaoben](https://github.com/Niuwh/yuketang-jiaoben) (以及可能未合并的PR的内容)
